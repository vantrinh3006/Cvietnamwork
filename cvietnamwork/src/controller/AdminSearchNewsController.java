...
public class AdminSearchNewsController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int numberOfNews = newsDAO.numberOfItems(keyWord);		 
		...
		ArrayList<News> news = newsDAO.getItemsPagination(offset, keyWord);		
		...
		request.getRequestDispatcher("/admin/news/search.jsp?active=4").forward(request, response);
